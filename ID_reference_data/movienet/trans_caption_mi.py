...
template = json.load(open('/mnt/bn/automl-aigc/yatai/data/shikra/flickr30k_mi.json', 'r'))
captions = json.load(open('./movie_gpt4v_new_caption_mi.json', 'r'))
caption_imgs = json.load(open('../movie_gpt4v_train_multiimg_new_caption.json', 'r'))
# print(len(caption_imgs))

ins_id = 0
res = []
anno_id = 0
for sample in tqdm(captions):
    img_info = caption_imgs[sample['img_idx']]
    ...
    question = question.replace('<image>', src_imgs)
...
with open('qwen_gpt4v_caption_mi_new.json', 'w') as f:
